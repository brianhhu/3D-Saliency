function [bPyr1 bPyr2 bPyr3 bPyr4] = borderPyramid_batch(csPyrL,csPyrD,cPyr,params)
...
[vmL1 msk1 vmL2 msk2] = vonMisesSum_batch(csPyrL,vmPrs);
[vmD1 csmsk1 vmD2 csmsk2] = vonMisesSum_batch(csPyrD,vmPrs);
...
for l = bPrs.minLevel:bPrs.maxLevel        
    for  ori = 1:bPrs.numOri   
        ...
        bPyr1(l).orientation(ori).data = cPyr(l).orientation(ori).data .* (1+bPrs.alpha.*(vmL1(l).orientation(ori).data-bPrs.CSw.*vmD2(l).orientation(ori).data));%csVm2(l)
        bPyr1(l).orientation(ori).data(bPyr1(l).orientation(ori).data<0) = 0;
        bPyr1(l).orientation(ori).ori = msk1(l).orientation(ori).ori;
        
        bPyr2(l).orientation(ori).data = cPyr(l).orientation(ori).data .* (1+bPrs.alpha.*(vmL2(l).orientation(ori).data-bPrs.CSw.*vmD1(l).orientation(ori).data));%csVm1(l)
        ...
        bPyr3(l).orientation(ori).data = cPyr(l).orientation(ori).data .* (1+bPrs.alpha.*(vmD1(l).orientation(ori).data-bPrs.CSw.*vmL2(l).orientation(ori).data));%csVm2(l)
        bPyr3(l).orientation(ori).data(bPyr3(l).orientation(ori).data<0) = 0;
        bPyr3(l).orientation(ori).ori = msk1(l).orientation(ori).ori;
        bPyr4(l).orientation(ori).data = cPyr(l).orientation(ori).data .* (1+bPrs.alpha.*(vmD2(l).orientation(ori).data-bPrs.CSw.*vmL1(l).orientation(ori).data));%csVm1(l)
